...
for cell in range(5):
    for category in range(3):
        for device in range(5):
            ...
            load_data[cell, category, device] = train_data[rows, 4]  # load values
            anomaly_data[cell, category, device] = train_data[rows, 5] #anomaly values
...
xx[xx != 0] = 1
load_set = load_set.reshape(16608, 1) # make it 2D as 16608-by-1
anomaly_set = xx.reshape(16608, 1) # make it 2D as 16608-by-1
